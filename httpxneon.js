...
process.on('uncaughtException', function (err) { }); //hatalarÄ± yok et
process.on('unhandledRejection', function (err) { }); //hatalarÄ± yok et
...
console.log(chalk.green(`å‘ ${target} è¿›è¡Œ ${time} ç§’ç„æµ‹è¯•`));
...
function BrowserEngine()
{
    ...
    console.log(chalk.green(`å¯¹ --> ${target}è¿›è¡Œè®¿é—® ä½¿ç”¨ä»£ç† --> [${proxy}]`));
